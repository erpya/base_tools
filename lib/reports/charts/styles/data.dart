...
/// Calculates the sum of the amounts used of a list of [SalesProductData].
double sumSalesProductData(List<SalesProductData> items) =>
    sumOf<SalesProductData>(items, (item) => item.amount);
