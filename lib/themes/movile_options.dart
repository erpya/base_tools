...
import 'package:base_tools/constants.dart';
...
class MovileOptions {
  ...
  static MovileOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, MovileOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
...
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = MovileOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ...
  final MovileOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late MovileOptions currentModel;
  ...
  void handleTimeDilation(MovileOptions newModel) {
  ...
  void updateModel(MovileOptions newModel) {
